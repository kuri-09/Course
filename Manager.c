...
void Manager_interrupt(SYSTEM_CLASS *SYSTEM, INTERRUPT_CLASS *INTERRUPT, MANAGER_CLASS *MANAGER){
	...
	&& (INTERRUPT->INPUT.WATER_LEVEL != EMPTY && INTERRUPT->INPUT.WATER_LEVEL != 31)
	...
	if(INTERRUPT->INPUT.COVER_STATE == COVER_OPEN || INTERRUPT->INPUT.WATER_LEVEL == EMPTY || INTERRUPT->INPUT.WATER_LEVEL == 31){
